...
if (isset($_GET['id'])) {
    ...
    try {
        // Reactivación + Auditoría completa (Quién y Cuándo)
        $stmt = $conexion->prepare("UPDATE usuario SET estado = 'Activo', modificado_por = :admin, fecha_modificacion = NOW() WHERE idusuario = :id");
